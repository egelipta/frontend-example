...
/** File Upload POST /api/v1/admin/user/file/upload */
export async function fileUploadApiV1AdminUserFileUploadPost(
  body: API.BodyFileUploadApiV1AdminUserFileUploadPost,
  file?: File,
  options?: { [key: string]: any },
) {
  const formData = new FormData();
  ...
  return request<any>('/api/v1/admin/user/file/upload', {
    method: 'POST',
    data: formData,
    requestType: 'form',
    ...(options || {}),
...
:param req:
:param photo:
:return: POST /api/v1/admin/user/photo/upload */
export async function photoUploadApiV1AdminUserPhotoUploadPost(
  body: API.BodyPhotoUploadApiV1AdminUserPhotoUploadPost,
  file?: File,
  options?: { [key: string]: any },
) {
  const formData = new FormData();
  ...
  return request<any>('/api/v1/admin/user/photo/upload', {
    method: 'POST',
    data: formData,
    requestType: 'form',
    ...(options || {}),
